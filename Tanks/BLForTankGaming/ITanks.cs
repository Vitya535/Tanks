...
{
    interface ITanks : IObjectsOnField // интерфейс для танков, не забыть паттерн "Состояние", "Стратегия", "Строитель"
    {
        ...
        //IStrategy strategy; // типа стратегия для танка (если ее можно будет сюда вставить)
